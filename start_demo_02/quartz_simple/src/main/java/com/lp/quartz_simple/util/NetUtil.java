package com.lp.quartz_simple.util;
...
public class NetUtil {
    ...
    public static String getIPV4() throws SocketException {
        return getLocalIp4Address().get().getHostAddress();
    }
    ...
    public static void main(String[] args) throws SocketException {
        String ipV4 = getLocalIp4Address().get().getHostAddress();
        System.out.println(ipV4);

        for (Inet4Address inet4Address : getLocalIp4AddressFromNetworkInterface()) {
            String addr = inet4Address.getHostAddress();
